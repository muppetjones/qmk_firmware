 ...
 */
    ...
    [_ADJUST] = LAYOUT_wrapper(
        RESET,   __ADJUST_L1________________________________,                                     _______, __FUNC_X1_________________________, _______,
        _______, __ADJUST_L2________________________________,                                     _______, __FUNC_X2_________________________, _______,
        _______, __ADJUST_L3________________________________, _______, _______, _______, _______, _______, __FUNC_X3_________________________, _______,
                                   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    )
    // /*
    //  * Layer template
