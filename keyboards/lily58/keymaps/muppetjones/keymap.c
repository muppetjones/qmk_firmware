...
[_CLMK_DH] = LAYOUT_wrapper(
    ...
    KC_CAPS, __COLEMAK_MOD_DH_L1________________________,                   __COLEMAK_MOD_DH_R1________________________, KC_BSPC,
...
[_LOWER] = LAYOUT_wrapper(
    ...
    _______, __SYMBOLS_L3_______________________________, _______, _______, __NUMPAD_R3________________________________, _______,
